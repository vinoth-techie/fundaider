                ...
                <div className="container">
                    ...
                    <div className="col-md-4 mb-3">
                        ...
                        <div className="card-body">
                            ...
                            <div className="mt-3">
                                <h4>{card.name}</h4>
                                <p className="text-secondary mb-1">{card.designation}</p>
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <a href={card.gitlink} target="_blank" rel="noreferrer"><span className="text-secondary">https://bootdey.com</span></a>
                            </li>
                            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <a href={card.gitlink} target="_blank" rel="noreferrer"><span className="text-secondary">gitlink</span></a>
                            </li>
                            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="col-sm-6 mb-3">
                            ...
                            <div className="card-body">
                                <h6 className="d-flex align-items-center mb-3"><i className="material-icons text-info mr-2"></i>Projects </h6>
